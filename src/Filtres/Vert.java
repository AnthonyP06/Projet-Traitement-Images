/**
 * Filtre ne gardant que la composante verte de chaque pixel
 * 
...
public class Vert implements Filtre
{
	public BufferedImage appliquerFiltre(BufferedImage image)
	{
		...
		for (int y = 0; y < traite.getHeight(); y++)
		{
			...
			{
				//Récupération de la couleur verte du pixel initial
				Color color = new Color(image.getRGB(x, y));
				int  green = color.getGreen();
				
				//Construction de la couleur de l'image traitée
				Color coloration = new Color(0, green, 0);
